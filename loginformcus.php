...
if(isset($_SESSION['username']))
			{
echo"<script>window.location='customer/test.php'</script>";
...
<form class="login100-form validate-form" name="login_form" id="login_form" method="post" autocomplete="off" action="loginformcus.php" >
			                                     ...
			                                     else
			                                         {
			                                             ...
			                                             if(mysqli_num_rows($query_run)>0)
			                                             {
			                                                 ...
			                                                 $_SESSION['username']=$username;
			 																								echo"<script>alert('login Succesful');window.location='customer/test.php'</script>";
